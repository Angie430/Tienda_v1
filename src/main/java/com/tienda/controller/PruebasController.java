...
//Los métodos siguientes son para la prueba de consultas ampliadas
    ...
    @GetMapping("/categoriasConProductosActivos")
public String categoriasConProductosActivos(Model model) {
    var categorias = categoriaService.findCategoriasConProductosActivos();
    model.addAttribute("categorias", categorias);
    model.addAttribute("totalCategorias", categorias.size());
    return "/pruebas/categoriasConProductosActivos";
}
